...
row = cur.fetchone()
if row is not None:
    print("Restarting existing crawl.  Remove spider2.sqlite to start a fresh crawl.")
else :
    starturl = input('Enter web url or enter (default: "https://timesofindia.indiatimes.com"): ')
    if ( len(starturl) < 1 ) : starturl = 'https://timesofindia.indiatimes.com'
